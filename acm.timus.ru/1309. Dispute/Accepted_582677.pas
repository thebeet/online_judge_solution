...
begin
 ...
 if n>14999999 then begin t:=9444;r:=15000001;end;
 if n>19999999 then begin t:=4499;r:=20000001;end;
 if n>24999999 then begin t:=8875;r:=25000001;end;
 if n>29999999 then begin t:=4056;r:=30000001;end;
 if n>34999999 then begin t:=2892;r:=35000001;end;
 if n>39999999 then begin t:=8401;r:=40000001;end;
 if n>45999999 then begin t:=7728;r:=45000001;end;
 if n>49999999 then begin t:=2823;r:=50000001;end;
 if n>54999999 then begin t:=6116;r:=55000001;end;
 if n>59999999 then begin t:=7298;r:=60000001;end;
 if n>64999999 then begin t:=4029;r:=65000001;end;
 if n>69999999 then begin t:=5886;r:=70000001;end;
 if n>74999999 then begin t:=2910;r:=75000001;end;
 if n>79999999 then begin t:=1103;r:=80000001;end;
 if n>84999999 then begin t:= 931;r:=85000001;end;
 if n>89999999 then begin t:=9888;r:=90000001;end;
 if n>94999999 then begin t:=7731;r:=95000001;end;
 for i:=r to n do
  t:=g(i,t);
 writeln(t);
end.
