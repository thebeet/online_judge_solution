...
struct t_queue
{
	...
	{
		if ((new_x >= 0) && (new_y >= 0) && (new_x < n) && (new_y < m) && (ans[new_t % m][new_x][new_y] > MAXN) && (getmap(new_t, new_x, new_y) != 'X'))
		{
