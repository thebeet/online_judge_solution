...
var countRangeSum = function(nums, lower, upper) {
    ...
    for (let num of nums) {
        ...
        sum += num;
        let currentUpper = sum - lower;
        let currentLower = sum - upper;
        //console.log(treap.countLessOrEqualThen(0.5));
        //console.log(treap.countLessOrEqualThen(-0.5));
        result += treap.countLessOrEqualThen(currentUpper + 0.5) - treap.countLessOrEqualThen(currentLower - 0.5);
        treap.insert(sum);
    }
    console.log(treap.size());
    return result;
